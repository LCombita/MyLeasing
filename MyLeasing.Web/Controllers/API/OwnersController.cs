...
namespace MyLeasing.Web.Controllers.API
{
    ...
    [ApiController]
    public class OwnersController : ControllerBase // hereda de esta
    {
        ...
        public async Task<IActionResult> GetOwnerByEmailAsync(EmailRequest request)
        {
            ...
            var response = new OwnerResponse
            {
                ...
                {
                    Address = p.Address,
                    Contracts = p.Contracts?.Select(c => new ContractResponse // el signo de interrogación hace valaidación de null
                    {
                        EndDate = c.EndDate,
                        Id = c.Id,
                        IsActive = c.IsActive,
