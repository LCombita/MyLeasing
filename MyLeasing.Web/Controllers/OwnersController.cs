...
{
    [Authorize(Roles = "Manager")] //Se restringe el acceso al controlador, solo entran con rol de manager
    public class OwnersController : Controller
    {
        ...
        // GET: Owners
        public IActionResult Index() //para ir a la vista Index: clic derecho 'Go To View
        {
            return View(_dataContext.Owners //los objeros que no se incluyan legan nulos a la DB y dan error
                .Include(o => o.User)
        ...
        public async Task<IActionResult> Details(int? id) //el signo de interrogaión pára decir que puede llegar nulo
        {
            if (id == null)
            {
                return NotFound();
        ...
        public async Task<IActionResult> Create(AddUserViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                ModelState.AddModelError(string.Empty, "User winth this email already exists.");
        ...
        public async Task<IActionResult> AddProperty(int? id)
        {
            ...
            {
                OwnerId = owner.Id,
                PropertyTypes = _combosHelper.GetComboPropertyTypes() //viene de CombosHelper y ICombosHelper
            };
        ...
        public async Task<IActionResult> AddContract(int? id)
        {
            ...
            //TODO: La fecha actual no está cargando en la web
        ...
        public async Task<IActionResult> DeleteProperty(int? id)
        {
            ...
            {
                ModelState.AddModelError(string.Empty, "The property can't be deleted because it has relationals contract.");
                return RedirectToAction($"{nameof(Details)}/{property.Owner.Id}");

            }

            _dataContext.PropertyImages.RemoveRange(property.PropertyImages); //delete relationals records 
            _dataContext.Contracts.RemoveRange(property.Contracts); //delete relationals records
